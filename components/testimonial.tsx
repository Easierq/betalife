...
const TestimonialCard = ({
  ...
  <div className="mb-8 bg-brand-gray rounded-xl py-8 px-6 sm:py-6">
    <div className="flex items-center justify-between gap-20">
      {/* <div className="hidden lg:hidden relative shrink-0 aspect-[3/4] max-w-[18rem] w-full bg-muted-foreground/20 rounded-xl">
        <Image
          src="/user.webp"
          fill
          alt=""
      ...
      <div className="flex flex-col justify-center">
        <div className="flex items-center justify-between gap-1">
          ...
          <div className="flex items-center gap-1">
            <StarIcon className="w-5 h-5 fill-brand-purple stroke-branfill-brand-purple" />
            <StarIcon className="w-5 h-5 fill-brand-purple stroke-branfill-brand-purple" />
            <StarIcon className="w-5 h-5 fill-brand-purple stroke-branfill-brand-purple" />
            <StarIcon className="w-5 h-5 fill-brand-purple stroke-branfill-brand-purple" />
            <StarIcon className="w-5 h-5 fill-brand-purple stroke-branfill-brand-purple" />
